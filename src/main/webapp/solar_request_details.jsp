...
if (request.getParameter("id") != null) {
	...
	SloarForm solar = new SloarForm();

	solar.deleteSolarForm(id);
%>
<script>
			...
			<div class="table-wrapper">
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td><%=rs.getString("soloar_Form_Id")%></td>
							...
							<td><a class="add" title="Add" data-toggle="tooltip"><i
									...
									<a class="edit" title="Edit" data-toggle="tooltip"href="solar_request_update.jsp?id=<%=rs.getString("soloar_Form_Id")%>"><i class="material-icons">&#xE254;</i></a>
									
									 <a class="delete"
								title="Delete" href="?id=<%=rs.getString("soloar_Form_Id")%>"><i
